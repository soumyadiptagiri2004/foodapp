const resturantModels = require("../models/resturentModels");
//create resturent
...
module.exports = { createResturantControllers, getAllResturantController, getResturantByIdController, deleteResturantController };